...
@section('content')
{!! Form::open(['route' => 'lapterima.cetak','name'=>'my-form','id'=>'my-form','class'=>'form-horizontal']) !!}
<div class="box box-danger box-solid">
  <div class="box-header with-border">
    <h3 class="box-title">@yield('title')</h3>
  </div>
    <div class="box-body">
      <div class="form-group{{ $errors->has('tgl1') ? ' has-error' : '' }} has-error">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-2">
          <select class="form-control select2" name="nomor" id="nomor">
            ...
            @foreach($list_terima as $terima)
              <option value="{{$terima->nomor}}">{{$terima->nomor}}</option>
            @endforeach
          </select>
        </div>
      </div>
    ...
    <div class="box-body">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label text-right">Supplier :</label>
        <div class="col-sm-4">
