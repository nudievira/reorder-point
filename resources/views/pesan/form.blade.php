...
<div class="row">
  ...
  <div class="box-body">
    ...
    <div class="box-footer text-center">
      ...
      <a href="{{url('pesan',$nomor)}}"  class="btn btn-info" name="print" id="print"><i class="fa fa-print"></i> Print</a>
      <a href="{{url('pesan')}}" class="btn btn-danger"><i class="fa fa-remove"></i> Close</a>
    </div>
...
$('#tanggal').datepicker({
  ...
  function cariKodeBarang()
  {
    ...
    var url = "<?php echo url('pesan/getDataBarang');?>";
  ...
  {
    var nomor = $("#nomor").val();
    var url = "<?php echo url('pesan/getDetail');?>";
    ...
    if(x==true)
    {
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          {
            window.location.replace("{{url('pesan')}}");
          }else{
            swal({
                title: "Info",
                text: data.info,
