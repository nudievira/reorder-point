  ...
  <div class="box-body">
    <div class="box box-danger box-solid">
          <div class="box-header">
            ...
            <a href="{{ route('jual.create')}}" class="btn btn-default btn-xs pull-right"  title="Create">
              ...
              @foreach($data as $row)
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <form action="{{ route('jual.destroy', $row->id) }}" method="POST">
                        {{csrf_field()}}
                        <a href="{{route('jual.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                        <input type="hidden" name="_method" value="DELETE">
                        <button type="submit" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></button>
                        <a href="{{url('jual',$row->nomor)}}" class="btn btn-info btn-xs"><i class="fa fa-print"></i></a>
                      </form>
                    </div>
                  </td>
                </tr>
