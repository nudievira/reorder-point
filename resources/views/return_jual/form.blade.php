...
<div class="row">
  ...
  {{-- <form class="form-horizontal"> --}}
    ...
    <div class="box-body">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-3 control-label text-right">No Penjualan :</label>
        <div class="col-sm-6">
  ...
  <div class="box-body">
    ...
    <div class="box-footer text-center">
      ...
      <a href="{{url('returnjual',$nomor)}}"  class="btn btn-info" name="print" id="print"><i class="fa fa-print"></i> Print</a>
      <a href="{{url('returnjual')}}" class="btn btn-danger"><i class="fa fa-remove"></i> Close</a>
    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @include('return_jual.databarang')
...
<script type="text/javascript">
  ...
  function listBarang()
  {
    ...
    var url = "<?php echo url('returnjual/listBarang');?>";
  ...
  function cariKodeBarang()
  {
    ...
    var url = "<?php echo url('returnjual/getDataBarang');?>";
  ...
  function detail()
  {
    ...
    var url = "<?php echo url('returnjual/getDetail');?>";
  ...
  function deleteDetail(id)
  {
    ...
    if(x==true)
    {
      // console.log(id);
      $.ajax({
        url   : "{{ route("returnjual.deleteDetail") }}",
        method : 'POST',
