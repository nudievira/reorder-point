@extends('layouts.app')
@section('title','Return Penjualan Barang')
@section('content')
<div class="row">
  <div class="box-body">
    <div class="box box-danger box-solid">
          <div class="box-header">
            ...
            <a href="{{ route('returnjual.create')}}" class="btn btn-default btn-xs pull-right"  title="Create">
              ...
              @foreach($data as $row)
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <form action="{{ route('returnjual.destroy', $row->id) }}" method="POST">
                        {{csrf_field()}}
                        <a href="{{route('returnjual.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
