  ...
  <div class="box-body">
    <div class="box box-danger box-solid">
          <div class="box-header">
            ...
            <a href="{{ route('pengguna.create')}}" class="btn btn-default btn-xs pull-right"  title="Create">
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <form action="{{ route('pengguna.destroy', $row->id) }}" method="POST">
                        {{csrf_field()}}
                        <a href="{{route('pengguna.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
